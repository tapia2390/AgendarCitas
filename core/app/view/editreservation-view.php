...
<option value="">-- SELECCIONE --</option>
  ...
  <?php endforeach; ?>
    ...
    <label for="inputEmail1" class="col-lg-2 control-label">Masajita</label>
    <div class="col-lg-4">
...
<option value="">-- SELECCIONE --</option>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-4">
    <textarea class="form-control" name="sick" placeholder="Alergia"><?php echo $reservation->sick;?></textarea>
    </div>
    ...
    <div class="col-lg-4">
    <textarea class="form-control" name="medicaments" placeholder="Productos"><?php echo $reservation->medicaments;?></textarea>
    </div>
